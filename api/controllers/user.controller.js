const User = require("../models/user.model"); //Importar el modelo del usuario
...
module.exports = { getAllUsers, createUser, getUser, updateUser, deleteUser }; //exportamos el CRUD
